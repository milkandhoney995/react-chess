...
describe("getPossiblePawnMoves", () => {
  it("should allow one step forward for white pawn", () => {
    const pawn: Piece = {
      id: "pawn",
      type: PieceType.PAWN,
  ...
  it("should allow two steps forward from starting position for white pawn", () => {
    const pawn: Piece = {
      id: "pawn",
      type: PieceType.PAWN,
      team: TeamType.OUR, // white
  ...
  it("should not allow two steps if blocked for white pawn", () => {
    const pawn: Piece = {
      id: "pawn",
      type: PieceType.PAWN,
      team: TeamType.OUR, // white
  ...
  it("should allow diagonal captures for white pawn", () => {
    const pawn: Piece = {
      id: "pawn",
      type: PieceType.PAWN,
      team: TeamType.OUR, // white
  ...
  it("should allow one step forward for black pawn", () => {
    const pawn: Piece = {
      id: "pawn",
      type: PieceType.PAWN,
  ...
  it("should allow two steps forward from starting position for black pawn", () => {
    const pawn: Piece = {
      id: "pawn",
      type: PieceType.PAWN,
      team: TeamType.OPPONENT, // black
